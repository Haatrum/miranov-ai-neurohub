🛰️ Miranov AI Assistant | Neuro-Hub v1.2
...
python -m eel main.py web --noconsole --name "Miranov_NeuroHub_v1.2" --icon "icon.ico" --add-data "model_vosk;model_vosk" --add-data "config.py;." --collect-all vosk --contents-directory .
